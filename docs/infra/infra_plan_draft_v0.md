...
| **版本** | v0.0-draft |
| **维护人** | R2 |
| **依据** | [governance_index_v1.md](../org/governance_index_v1.md) · [plan_review_w1.md](../meeting/plan_review_w1.md) · [blueprint_v0.md](../architecture/blueprint_v0.md) · [budget_v2_framework.md](../plan/budget_v2_framework.md) |

---

## 一、网络拓扑设计 (满足 <10ms 延迟)

为满足 R1 提出的“端到端控制延迟 <10ms”的 NFR，实验室网络必须与办公网络**物理/逻辑隔离**。
...
基于 R1 在总体方案中冻结的基线：“最大 2 台设备并发，全量录制 rosbag”。
...
本节仅估算网络与存储基础设施成本；**框架建设总预算见 [PLAN-BUDGET-02](../plan/budget_v2_framework.md)**。
